public class KioskMain {
    ...
    public static void main(String[] args) {
        ...
        addBurgersMenuItem(burgers);
        addDrinksMenuItem(drinks);
        addDessertsMenuItem(desserts);
    ...
    static void addBurgersMenuItem(Menu burgers) {
    ...
    static void addDrinksMenuItem(Menu drinks) {
    ...
    static void addDessertsMenuItem(Menu desserts) {
